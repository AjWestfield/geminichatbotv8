...
>(({ className, children, ...props }, ref) => {
  // Use a stable ref to prevent infinite loops
  const stableRef = React.useRef<React.ElementRef<typeof ScrollAreaPrimitive.Root>>(null)
...
export { ScrollAreaSafe, ScrollBar }